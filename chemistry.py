...
class PeriodicTable:
    def __init__(self):
        ...
        # how would it be like if I took this from mogli?
        ...
        self.__atomic_colors = [(0, 0, 0),  # Avoid atomic number to index conversion
    ...
    def get_markercolor(self, element):
        ...
        temp = list(self.__atomic_colors[atomic_number])
        color_list = []
        for rgb in temp:
